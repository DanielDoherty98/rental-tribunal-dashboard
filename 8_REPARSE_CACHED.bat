...
echo ==============================================================
echo  Re-parse cached documents - NO downloading
echo ==============================================================
echo.
echo Use this after a parser fix. It rebuilds every record from the
echo documents already on disk, so corrected rent figures appear
echo across the whole dataset in minutes.
echo.
python run_all.py --reparse
